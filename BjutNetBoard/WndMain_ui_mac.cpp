...
void bna::gui::WndMain::layoutUI()
{
    ...
    m_lblStatus->setGeometry(QRect(0, 20, 50, 20));
    m_lblStatus->setFont(font_s120);
    m_lblStatusFlag->setGeometry(QRect(35, 20, 20, 20));
    m_lblStatusFlag->setFont(font_s120);
    m_btnRefresh->setGeometry(QRect(55, 20, 20, 20));
    m_btnRefresh->setFlat(true);
    m_btnRefresh->setFont(font_s120);
    m_btnSetting->setGeometry(QRect(0, 40, 20, 20));
    m_btnSetting->setFlat(true);
    m_btnSetting->setFont(font_s120);
    m_btnHelp->setGeometry(QRect(20, 40, 20, 20));
    ...
    m_lblFlowUsed->setGeometry(QRect(m_frmFlowGraph->x()+50, 20, 100, 20));
    m_lblFlowUsed->setFont(font_s115);
    //账户状态
    ...
    //上线按钮
    m_btnLogin->setGeometry(QRect(310, 140, 85, 34));
    //下线按钮
    m_btnLogout->setGeometry(QRect(410, 140, 85, 34));
    //展开按钮
    m_btnDetail->setGeometry(QRect(510, 140, 50, 34));
    ...
    m_btnOnline1->setGeometry(QRect(m_frmOnline->width()-85, 20, 80, 34));
    m_btnOffline1->setGeometry(QRect(m_btnOnline1->pos().x()-85, 20, 80, 34));
    m_btnForceOffline1->setGeometry(QRect(m_btnOffline1->pos().x()-90, 20, 80, 34));
    ...
    m_btnOnline2->setGeometry(QRect(m_frmOnline->width()-85, 80, 80, 34));
    m_btnOffline2->setGeometry(QRect(m_btnOnline2->pos().x()-85, 80, 80, 34));
    m_btnForceOffline2->setGeometry(QRect(m_btnOffline2->pos().x()-90, 80, 80, 34));
    ...
    m_btnRefreshBook->setGeometry(QRect(10, 80, 80, 34));
    m_btnRefreshBook->setFont(font_s115);
    m_btnSubmitBook->setGeometry(QRect(90, 80, 80, 34));
    ...
    m_btnBjutWeb1->setGeometry(QRect(20, 23, 130, 34));
    m_btnBjutWeb1->setFont(font_s115);
    m_btnBjutWeb2->setGeometry(QRect(20, 53, 130, 34));
    m_btnBjutWeb2->setFont(font_s115);
    m_btnBjutWeb3->setGeometry(QRect(20, 83, 130, 34));
    m_btnBjutWeb3->setFont(font_s115);
    m_btnBjutWeb4->setGeometry(QRect(180, 23, 130, 34));
    m_btnBjutWeb4->setFont(font_s115);
    m_btnBjutWeb5->setGeometry(QRect(180, 53, 130, 34));
    m_btnBjutWeb5->setFont(font_s115);
    m_btnBjutWebMore->setGeometry(QRect(180, 83, 130, 34));
    m_btnBjutWebMore->setFont(font_s115);
