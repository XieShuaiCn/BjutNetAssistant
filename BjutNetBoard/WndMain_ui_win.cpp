...
void bna::gui::WndMain::layoutUI()
{
    ...
    m_frmFlowGraph->setGeometry(QRect(115,0,162,162));
    m_frmFlowGraph->setFrameShape(QFrame::NoFrame);
    m_frmFlowGraph->setFrameShadow(QFrame::Plain);
    m_lblFlowUsed->setGeometry(QRect(m_frmFlowGraph->x()+50, 20, 100, 40));
    m_lblFlowUsed->setAlignment(Qt::AlignHCenter|Qt::AlignTop);
    ...
    m_lblClent1_ip4->setFont(font_s115);
    m_lblClent1_ip6->setGeometry(QRect(10, 52, 40, 20));
    m_lblClent1_ip6->setFont(font_s115);
    m_lblClent1_addr4->setGeometry(QRect(55, 22, 250, 20));
    m_lblClent1_addr4->setFont(font_s115);
    ...
    m_lblClent2_ip4->setFont(font_s115);
    m_lblClent2_ip6->setGeometry(QRect(10, 112, 40, 20));
    m_lblClent2_ip6->setFont(font_s115);
    m_lblClent2_addr4->setGeometry(QRect(55, 82, 250, 20));
    m_lblClent2_addr4->setFont(font_s115);
