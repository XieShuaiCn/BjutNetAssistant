...
bna_gui_HttpClient::bna_gui_HttpClient()
{
...
bool bna_gui_HttpClient::setCodec(const QByteArray &codeName)
{
//    if (m_pCodec)
//    {
...
void bna_gui_HttpClient::push_message(const QDateTime &time, const QString &info)
{
    m_arrMessage.push_back(QPair<QDateTime, QString>(time, info));
}

bool bna_gui_HttpClient::pop_message(QDateTime& time, QString& info)
{
...
void bna_gui_HttpClient::clear_message()
{
    m_arrMessage.clear();
}

QString bna_gui_HttpClient::getUrlHtml(const QUrl &url)
{
    QString content;
...
int bna_gui_HttpClient::getUrlHtml(const QUrl &url, QString &content)
{
    QByteArray data;
    content.clear();
...
QString bna_gui_HttpClient::postUrlHtml(const QUrl &url, const QMap<QString, QString> &data)
{
    QString content;
...
int bna_gui_HttpClient::postUrlHtml(const QUrl &url, const QMap<QString, QString> &data, QString &content)
{
    QString arg;
    auto end = data.cend();
...
QString bna_gui_HttpClient::postUrlHtml(const QUrl &url, const QString &arg)
{
    QString content;
...
int bna_gui_HttpClient::postUrlHtml(const QUrl &url, const QString &arg, QString &content)
{
...
int bna_gui_HttpClient::downloadFile(const QUrl &url, const QByteArray &arg, const QString &fileName, bool bPost)
{
    //建立http连接
...
int bna_gui_HttpClient::downUrlData(const QUrl &url, const QByteArray &arg, QByteArray &content, bool bPost/*=true*/)
{
    //建立http连接
    QNetworkRequest request;
    if(url.scheme() == "https"){
